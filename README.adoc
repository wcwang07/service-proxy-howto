...
You can run the service and a local Neo4j instance with:
...
The HTTP API is exposed at `http://localhost:8090/query`, and Neo4j Browser is exposed at `http://localhost:7474`.

The service reads Neo4j connection settings from environment variables:
